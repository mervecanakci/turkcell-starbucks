...
class QSDSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class QSDExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(QSDDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new QSDStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static QSDDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static QSDDateTimeConverter dateTimeConverter = new QSDStandardDateTimeConverter();

    public QSDExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public QSDExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new QSDMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=QSDHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,QSDExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=QSDHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
