...
public class QSDKPSPublicSoap
{
    ...
    public QSDKPSPublicSoap(){}

    public QSDKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public QSDKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        QSDExtendedSoapSerializationEnvelope envelope= new QSDExtendedSoapSerializationEnvelope(QSDExtendedSoapSerializationEnvelope.VER11);
